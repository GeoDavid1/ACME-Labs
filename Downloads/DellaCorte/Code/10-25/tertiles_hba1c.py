...
tertiles_intake_nmes = merged_data_1['Weighted Average for ecid_hba1c_percent'].quantile([0, 1/3, 2/3, 1])
...
merged_data_1['intake_nmes_tertile'] = pd.cut(merged_data_1['Weighted Average for ecid_hba1c_percent'], bins=tertiles_intake_nmes, labels=[1, 2, 3])
...
output_file = '/Users/user/Downloads/DellaCorte/Cum_Final_Data_Hba1c.xlsx'
sheet = 'Averages_by_Hba1c_Tertile'
